  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      ...
      <p className="text-sm leading-6 text-gray-900">
        <a href="#">
          <strong className="font-semibold">Website Launch Celebration</strong>
          <svg
            viewBox="0 0 2 2"
          ...
          To celebrate the launch of our website, we're offering exciting
          specials for a limited time only. Indulge in our luxurious treatments
          and let us pamper you like never before. Book your appointment today
          and treat yourself to the ultimate spa experience!
