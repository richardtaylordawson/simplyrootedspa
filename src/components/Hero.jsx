...
import Spa from "@/images/newhero.png"
            ...
            <div className="px-6 lg:col-span-7 lg:px-0 xl:col-span-6">
              <div className="mx-auto max-w-2xl lg:mx-0">
                <div className="hidden sm:flex">
                  <div className="relative mb-8 rounded-full py-1 px-3 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                ...
                <h1 className="text-9xl font-bold tracking-tight text-gray-900">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <a
                    href="#"
                    className="rounded-md bg-simplyrooted-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-simplyrooted-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-simplyrooted-600"
                  >
                    Book Appointment
                  </a>
                  <a
