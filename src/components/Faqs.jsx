    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        ...
        <p className="mt-6 max-w-2xl text-base leading-7">
          ...
          <a
            href="#"
            className="font-semibold text-simplyrooted-600 hover:text-simplyrooted-500"
          >
            sending us an email
          </a>{" "}
        ...
        <div className="mt-10">
          <dl className="space-y-8 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-8 sm:space-y-0 lg:gap-x-10">
            {faqs.map((faq) => (
              <div key={faq.id}>
                <dt className="text-base text-lg font-semibold leading-7">
                  {faq.question}
                </dt>
                <dd className="text-medium text-md mt-2 leading-7">
                  {faq.answer}
                </dd>
              </div>
            ))}
